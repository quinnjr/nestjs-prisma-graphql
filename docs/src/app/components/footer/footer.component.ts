        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div class="col-span-2 md:col-span-1">
            <a routerLink="/" class="flex items-center gap-3 mb-4">
              <div
                class="w-10 h-10 rounded-xl bg-gradient-to-br from-pegasus-500 to-forge-500 flex items-center justify-center"
              >
                <svg
            ...
            <ul class="space-y-2">
              <li>
                <a
                  ...
                  class="text-steel-400 hover:text-pegasus-400 transition-colors text-sm"
                  >Getting Started</a
                >
              </li>
              <li>
            ...
            <ul class="space-y-2">
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener"
                  class="text-steel-400 hover:text-pegasus-400 transition-colors text-sm flex items-center gap-2"
                >
              ...
              <li>
                <a
                  href="https://github.com/quinnjr/nestjs-prisma-graphql/issues"
                  target="_blank"
                  rel="noopener"
                  class="text-steel-400 hover:text-pegasus-400 transition-colors text-sm"
                >
              ...
              <li>
                <a
                  href="https://github.com/quinnjr/nestjs-prisma-graphql/discussions"
                  target="_blank"
                  rel="noopener"
                  class="text-steel-400 hover:text-pegasus-400 transition-colors text-sm"
                >
