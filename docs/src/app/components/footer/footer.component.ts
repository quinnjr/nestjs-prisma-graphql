      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul class="space-y-2">
              <li>
                <a href="https://github.com/quinnjr/nestjs-prisma-graphql" target="_blank" rel="noopener" class="text-steel-400 hover:text-pegasus-400 transition-colors text-sm flex items-center gap-2">
              ...
              <li>
                <a href="https://github.com/quinnjr/nestjs-prisma-graphql/issues" target="_blank" rel="noopener" class="text-steel-400 hover:text-pegasus-400 transition-colors text-sm">
                  Report Issue
                </a>
              </li>
              <li>
                <a href="https://github.com/quinnjr/nestjs-prisma-graphql/discussions" target="_blank" rel="noopener" class="text-steel-400 hover:text-pegasus-400 transition-colors text-sm">
                  Discussions
                </a>
              </li>
            </ul>
